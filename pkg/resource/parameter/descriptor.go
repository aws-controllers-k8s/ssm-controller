...
const (
	FinalizerString = "finalizers.ssm.services.k8s.aws/Parameter"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("parameters")

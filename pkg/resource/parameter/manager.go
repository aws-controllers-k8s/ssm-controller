...
// +kubebuilder:rbac:groups=ssm.services.k8s.aws,resources=parameters,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ssm.services.k8s.aws,resources=parameters/status,verbs=get;update;patch

var lateInitializeFieldNames = []string{"DataType"}
...
func (rm *resourceManager) lateInitializeFromReadOneOutput(
	...
	if observedKo.Spec.DataType != nil && latestKo.Spec.DataType == nil {
		latestKo.Spec.DataType = observedKo.Spec.DataType
	}

...
const (
	FinalizerString = "finalizers.ssm.services.k8s.aws/PatchBaseline"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("patchbaselines")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.PatchBaseline{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.PatchBaseline),
	}
}

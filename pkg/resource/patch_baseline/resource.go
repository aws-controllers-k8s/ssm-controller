...
func (r *resource) SetIdentifiers(identifier *ackv1alpha1.AWSIdentifiers) error {
	...
	f0, f0ok := identifier.AdditionalKeys["baselineID"]
	if f0ok {
		r.ko.Status.BaselineID = aws.String(f0)
	}
...
func (r *resource) PopulateResourceFromAnnotation(fields map[string]string) error {
	...
	f0, ok := fields["baselineID"]
	if !ok {
		return ackerrors.NewTerminalError(fmt.Errorf("required field missing: baselineID"))
	}
	r.ko.Status.BaselineID = &f0

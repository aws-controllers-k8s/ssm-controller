...
// +kubebuilder:rbac:groups=ssm.services.k8s.aws,resources=patchbaselines,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ssm.services.k8s.aws,resources=patchbaselines/status,verbs=get;update;patch

...
// +kubebuilder:rbac:groups=ssm.services.k8s.aws,resources=documents,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ssm.services.k8s.aws,resources=documents/status,verbs=get;update;patch

...
const (
	FinalizerString = "finalizers.ssm.services.k8s.aws/Document"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("documents")

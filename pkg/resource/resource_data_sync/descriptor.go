...
const (
	FinalizerString = "finalizers.ssm.services.k8s.aws/ResourceDataSync"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("resourcedatasyncs")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.ResourceDataSync{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.ResourceDataSync),
	}
}

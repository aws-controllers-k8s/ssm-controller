...
import (
	...
	svcsdkapi "github.com/aws/aws-sdk-go/service/ssm/ssmiface"
...
// +kubebuilder:rbac:groups=ssm.services.k8s.aws,resources=resourcedatasyncs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ssm.services.k8s.aws,resources=resourcedatasyncs/status,verbs=get;update;patch
